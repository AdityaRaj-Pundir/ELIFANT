                ...
                `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=${API_KEY}`,
                {
                    ...
                    body: JSON.stringify({
                        contents: [
                            {
                                parts: [
                                    { text: "DO NOT USE MARKDOWN WHEN GENERATING TEXT. Look at this picture of my fridge. List out all the ingredients in the fridge in a comma separated list all at once in this format: 'The ingredients in your frige are: a, b, c...'. Suggest a simple recipe I can make. Explain it step by step in simple words. " +
                                            "Number the steps clearly. Return the output in plaintext format." },
